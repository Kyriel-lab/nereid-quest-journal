...
## v3.4 — Manifestation Completion Lock

**Status:** Patch candidate.

### Added / Changed

- Polished completed Manifestation copy after Astrael Lanternveil is manifested.
- Updated Manifestation status display to:
  - `Manifested · Complete`
- Static planned requirement preview now hides after Manifestation is complete.
- Added completion styling for the manifested Resonant Manifestation card.
- Locks the canon presentation:
  - Manifestation is a completed resonance branch.
  - Manifestation does not replace the creature form.
  - Companion Card image remains the normal creature evolution image.

### Preserved

- v3.3 Companion Card Resonance Badge.
...
- No Manifestation ritual logic changes.
- No Manifestation asset behavior changes.
...
- Added a Companion Card resonance status row.
- The resonance row stays hidden until Astrael Lanternveil is manifested.
- After Manifestation unlock, Companion Card displays:
  - `Resonance`
  - `Manifested · Astrael Lanternveil`
- Companion Card image remains the current creature form and does not switch to the Manifestation image.
...
- Added standalone `createManifestationSignsMarkup(progress)` helper.
- The helper prepares Resonant Manifestation requirement signs markup for Astrael Lanternveil:
  - Evolution III
  - Bond
  - Moonlit Fragments
  - Fragment ledger
  - Resonant Memory
  - Alignment copy
- Added a small dormant CSS class for future Manifestation signs styling.
- This patch only adds the markup helper and does not connect it to Moonlit Resonance UI yet.
...
- No renderAll changes.
- No renderMoonlitResonance changes.
- No `manifestationBranchSigns` HTML hook.
- No dynamic Manifestation signs rendered in UI.
- No Manifestation ritual.
- No Manifestation unlock action.
- No Manifestation asset reveal.
...
- Added standalone `getManifestationProgress()` helper for Astrael Lanternveil.
- The helper calculates:
  - Evolution III awakened
  - Lifetime Bond progress
  - Available / earned / spent Moonlit Fragments
  - Resonant Memory unlocked
  - Manifestation readiness
- The helper uses the existing `MANIFESTATION_REQUIREMENTS` constant.
- This patch only adds the helper and does not connect it to Moonlit Resonance UI yet.
...
- No `createManifestationSignsMarkup()`.
- No Manifestation ritual.
- No Manifestation unlock action.
- No Manifestation asset reveal.
- No Companion Card manifestation image swap.
...
- Fixed app load crash:
  - `ReferenceError: Cannot access 'LANTERN_JELLY_MANIFESTATION' before initialization`
- `normalizeCompanionResonance()` now uses the safe literal fallback:
  - `Astrael Lanternveil`
- This prevents `loadState()` / `createDefaultState()` from crashing before the Manifestation constant is initialized.

### Preserved

- v2.2a Static Manifestation Requirement Copy, if applied.
- v2.1 Resonant Manifestation State Foundation.
- v2.0 Moonlit Resonance UI Foundation.
- v1.9 Evolution Track Completion Lock.
- Evolution III Asset Integration from v1.8.
...
- No Quest logic changes.
- No Stats logic changes.
- No Achievements logic changes.
- No dynamic Manifestation requirement calculation.
- No Manifestation ritual.
- No Manifestation unlock action.
- No Manifestation asset reveal.
